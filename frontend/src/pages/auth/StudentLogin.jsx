...
import { GraduationCap, ArrowLeft, AlertCircle, Lock, User } from "lucide-react";

export default function StudentLogin() {
  const [id, setId] = useState("20230204064");
    ...
    <div className="min-h-screen bg-[#F4F7FB] flex flex-col justify-center items-center px-4 py-12 relative font-sans">
      ...
      <div className="w-full max-w-md bg-white border border-slate-200/90 rounded-3xl shadow-soft-lg p-8 sm:p-10">
        ...
        <div className="flex items-center gap-3.5 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#384959]">Student Login</h2>
            <p className="text-xs text-[#6A89A7]">Sign in with your Student ID & Password</p>
          </div>
        </div>
        ...
        <div className="mt-8 pt-4 border-t border-slate-100 text-center text-xs text-[#6A89A7]">
          ...
          <Link to="/student/register" className="text-[#384959] font-bold hover:underline">
            Register profile
          </Link>
        </div>
      </div>
